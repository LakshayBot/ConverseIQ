...
console.log(`GitHub Repository: Zackriya-Solutions/callpilot`);
...
bundleFiles.forEach(filename => {
  ...
  if (platform && !platforms[platform]) {
    ...
    const githubUrl = `https://github.com/Zackriya-Solutions/callpilot/releases/download/${versionDir}/${filename}`;
...
console.log(`   URL: https://github.com/Zackriya-Solutions/callpilot/releases/new?tag=v${versionClean}`);
...
console.log(`   curl https://github.com/Zackriya-Solutions/callpilot/releases/latest/download/latest.json`);
