...
impl Setting {
    ...
    /// Stub: kept for schema compatibility — the local desktop agent no longer
    /// hosts a custom OpenAI override; the .NET Gateway does that.
    pub fn get_custom_openai_config(&self) -> Option<crate::database::repositories::setting::CustomOpenAIConfig> {
