...
// Conditional logging macros for hot paths. No-ops in release builds.
// `#[macro_export]` exposes these at crate root so any module can call
// `perf_debug!(...)` / `perf_trace!(...)` without re-importing.
#[macro_export]
