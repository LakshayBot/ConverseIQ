...
impl ContinuousVadProcessor {
    ...
    /// Returns a snapshot of the currently accumulated speech, or None if the VAD
    /// isn't currently in speech. The pipeline uses this to emit interim "partial"
    ...
    pub fn interim_snapshot(&self) -> Option<SpeechSegment> {
        ...
        Some(SpeechSegment {
            ...
            confidence: 0.7, // Lower confidence for interim; final segment carries higher
        })
    }

    /// True if the VAD is currently inside a speech region.
