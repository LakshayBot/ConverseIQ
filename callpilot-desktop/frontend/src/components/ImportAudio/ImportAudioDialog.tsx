      ...
      >
        ...
        <div className="space-y-4 py-4">
          ...
          {!isProcessing && !error && (
            <>
              {fileInfo ? (
                <div className="bg-[var(--opaline-surface-container-low)] rounded-lg p-4 space-y-3">
                  <div className="flex items-start gap-3">
                    <FileAudio className="h-8 w-8 text-primary flex-shrink-0" />
                    <div className="flex-1 min-w-0">
                      <p className="font-medium text-[var(--opaline-on-surface)] truncate">{fileInfo.filename}</p>
                      <div className="flex items-center gap-4 text-sm text-[var(--opaline-outline)] mt-1">
                  ...
                  <div className="space-y-1">
                    <label className="text-sm font-medium text-[var(--opaline-on-surface-variant)]">Meeting Title</label>
                    <Input
                      value={title}
                      onChange={(e) => {
                ...
                <div className="border-2 border-dashed border-[var(--opaline-outline-variant)] rounded-lg p-8 text-center">
                  <FileAudio className="h-12 w-12 text-[var(--opaline-outline)] mx-auto mb-4" />
                  ...
                  <p className="text-sm text-[var(--opaline-outline)] mt-2">MP4, WAV, MP3, FLAC, OGG, MKV, WebM, WMA</p>
                </div>
              )}
              ...
              {fileInfo && (
                <div className="border rounded-lg">
                  <button
                    ...
                    className="w-full flex items-center justify-between p-3 text-sm font-medium text-[var(--opaline-on-surface-variant)] hover:bg-[var(--opaline-surface-container-low)]"
                  >
          ...
          {isProcessing && progress && (
            <div className="space-y-2">
              <div className="relative">
                <div className="w-full bg-[var(--opaline-surface-container)] rounded-full h-3">
                  <div
                    className="bg-primary h-3 rounded-full transition-all duration-300 ease-out"
                    style={{ width: `${Math.min(progress.progress_percentage, 100)}%` }}
                  />
                </div>
                <div className="flex justify-between text-xs text-[var(--opaline-on-surface-variant)] mt-1">
          ...
          {/* Error display */}
          {error && (
            <div className="bg-[var(--opaline-danger-soft)] border border-[var(--opaline-danger-border)] rounded-lg p-3">
          ...
          {!isProcessing && !error && (
            <>
              ...
              <Button
                ...
                className="bg-primary hover:bg-[var(--opaline-primary-hover)]"
                disabled={!fileInfo}
              >
                <Upload className="h-4 w-4 mr-2" />
                Import
