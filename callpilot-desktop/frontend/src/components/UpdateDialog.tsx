        ...
        <div className="space-y-4 py-4">
          {!isDownloading && !error && (
            <>
              ...
              {updateInfo.body && (
                <div className="bg-[var(--opaline-surface-container-low)] rounded-lg p-3 max-h-40 overflow-y-auto">
                  <p className="text-sm text-[var(--opaline-on-surface-variant)] whitespace-pre-wrap">
                    {updateInfo.body}
                  </p>
                </div>
              )}
        ...
        <DialogFooter>
          {!isDownloading && !error && (
            <>
              ...
              <Button onClick={handleDownloadAndInstall} className="bg-primary hover:bg-[var(--opaline-primary-hover)]">
