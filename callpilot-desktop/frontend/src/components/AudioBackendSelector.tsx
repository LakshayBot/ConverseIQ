  ...
  if (loading) {
    return (
      <div className="animate-pulse">
        <div className="h-4 bg-[var(--opaline-surface-container)] rounded w-32 mb-2"></div>
  ...
  return (
    <div className="space-y-2">
      <div className="flex items-center gap-2">
        <label className="text-sm font-medium text-[var(--opaline-on-surface-variant)]">
        ...
        <div className="relative">
          <button
            ...
            className="text-[var(--opaline-outline)] hover:text-[var(--opaline-on-surface-variant)] transition-colors rounded focus:outline-none focus-visible:ring-2 focus-visible:ring-[var(--opaline-primary)]"
          >
            <Info className="h-4 w-4" />
          </button>
          {showTooltip && (
            <div className="absolute z-10 left-6 top-0 w-64 p-3 text-xs bg-[var(--opaline-ink)] text-white rounded-lg shadow-lg">
              ...
              <p className="mt-2 text-[var(--opaline-outline)]">
      ...
      {error && (
        <div className="p-2 text-xs text-danger bg-[var(--opaline-danger-soft)] border border-[var(--opaline-danger-border)] rounded-md">
          {error}
        </div>
      )}
          ...
          return (
            <label
              ...
              className={`flex items-start p-3 border rounded-xl transition-all ${
                currentBackend === backend.id
                  ? 'border-primary bg-[var(--opaline-primary-soft)]'
                  : 'border-[var(--opaline-outline-variant)] hover:border-[var(--opaline-outline)] bg-[var(--opaline-surface-container-lowest)]'
            ...
            >
              <input
                ...
                disabled={isDisabled}
                className="mt-1 h-4 w-4 text-primary focus:ring-ring border-[var(--opaline-outline-variant)]"
              />
              <div className="ml-3 flex-1">
                ...
                <p className="mt-1 text-xs text-[var(--opaline-on-surface-variant)]">{backend.description}</p>
              </div>
            </label>
          );
        })}
