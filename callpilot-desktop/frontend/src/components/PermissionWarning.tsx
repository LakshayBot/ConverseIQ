  ...
  return (
    <div className="max-w-md mb-4 space-y-3">
      ...
      {(!hasMicrophone || !hasSystemAudio) && (
        <Alert variant="destructive" className="border-[var(--opaline-warning-border)] bg-[var(--opaline-warning-soft)]">
          ...
          <div className="mt-4 flex flex-wrap gap-2">
            {isMacOS && !hasMicrophone && (
              <button
                ...
                className="inline-flex items-center gap-2 px-4 py-2 text-sm font-medium text-background bg-[var(--opaline-warning)] hover:brightness-95 rounded-md transition-colors focus-ring"
              >
            ...
            {isMacOS && !hasSystemAudio && (
              <button
                ...
                className="inline-flex items-center gap-2 px-4 py-2 text-sm font-medium text-primary-foreground bg-primary hover:bg-[var(--opaline-primary-hover)] rounded-md transition-colors focus-ring"
              >
            ...
            <button
              ...
              className="inline-flex items-center gap-2 px-4 py-2 text-sm font-medium text-warning bg-[var(--opaline-warning-soft)] hover:bg-[var(--opaline-warning-border)] rounded-md transition-colors disabled:opacity-50 focus-ring"
            >
          ...
          <AlertDescription className="text-warning mt-2">
            ...
            {!hasMicrophone && (
              <>
                <p className="mb-3">
                  CallPilot needs access to your microphone to record meetings. No microphone devices were detected.
                </p>
                ...
                {isMacOS && (
                  <div className="space-y-2 text-sm mb-4">
                    ...
                    <ul className="list-disc list-inside ml-2 space-y-1">
                      ...
                      <li>Grant Screen Recording permission to CallPilot</li>
