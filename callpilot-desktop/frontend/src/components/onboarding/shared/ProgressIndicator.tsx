              ...
              <button
                ...
                className={`relative flex items-center justify-center transition-all duration-300 ${
                  isCompleted
                    ...
                    : isActive
                      ? 'w-8 h-8 bg-[var(--opaline-ink)] rounded-full'
                      : 'w-6 h-6 bg-[var(--opaline-surface-container-high)] rounded-full'
                ...
                {isCompleted ? (
                  ...
                  <StepIcon
                    className={`transition-all duration-300 ${
                      isActive ? 'w-4 h-4 text-white' : 'w-3 h-3 text-[var(--opaline-on-surface-variant)]'
                    }`}
                  />
                )}
              </button>
              ...
              {index < visibleSteps.length - 1 && (
                <div
                  className={`h-0.5 w-6 transition-all duration-300 ${
                    isCompleted ? 'bg-success' : 'bg-[var(--opaline-surface-container-high)]'
                  }`}
                />
              )}
            </React.Fragment>
