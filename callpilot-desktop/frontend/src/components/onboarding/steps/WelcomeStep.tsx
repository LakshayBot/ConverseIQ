    ...
    >
      <div className="flex flex-col items-center space-y-10">
            ...
            return (
              <div key={index} className="flex items-start gap-3">
                <div className="flex-shrink-0 mt-0.5">
                  <div className="w-5 h-5 rounded-full bg-[var(--opaline-surface-container-low)] flex items-center justify-center">
                    <Icon className="w-3 h-3 text-[var(--opaline-on-surface-variant)]" />
                  </div>
                </div>
                <p className="text-sm text-[var(--opaline-on-surface-variant)] leading-relaxed">{feature.title}</p>
              </div>
            );
          })}
        </div>
        ...
        <div className="w-full max-w-xs space-y-3">
          ...
          <p className="text-xs text-center text-[var(--opaline-outline)]">Takes less than 3 minutes</p>
        </div>
      </div>
    </OnboardingContainer>
  );
