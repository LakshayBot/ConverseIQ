...
export function DownloadProgressStep() {
  ...
  return (
    <OnboardingContainer
      ...
      description="You can start using CallPilot after downloading the Transcription Engine."
      step={3}
    ...
    >
      <div className="flex flex-col items-center space-y-6">
        ...
        <div className="w-full max-w-lg space-y-4">
          ...
          {/* Summary Engine card removed: CallPilot handles summarization server-side
              via the .NET Gateway + configured provider (see Settings → CallPilot). */}
        </div>
