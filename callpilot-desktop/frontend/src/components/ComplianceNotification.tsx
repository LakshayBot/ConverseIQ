...
export const ComplianceNotification: React.FC<ComplianceNotificationProps> = ({
  ...
  return (
    ...
    >
      <div className="bg-[var(--opaline-surface-container-lowest)] border border-[var(--opaline-outline-variant)] rounded-lg shadow-lg p-3">
        {/* Header with close button */}
        <div className="flex items-start justify-between mb-2">
          <div className="flex items-center gap-1">
            <AlertTriangle className="h-3 w-3 text-warning flex-shrink-0" />
            <h3 className="text-xs font-semibold text-[var(--opaline-on-surface)]">
              Recording Notice
            </h3>
          </div>
          <button
            onClick={handleClose}
            className="text-[var(--opaline-outline)] hover:text-[var(--opaline-on-surface-variant)] transition-colors p-0.5 rounded hover:bg-[var(--opaline-surface-container-low)]"
          >
            <X className="h-3 w-3" />
          </button>
        </div>
        ...
        {/* Content */}
        <div className="mb-2">
          <p className="text-xs text-[var(--opaline-on-surface-variant)] mb-1">
            Inform participants about recording.
          </p>
          <div className="bg-[var(--opaline-warning-soft)] border border-[var(--opaline-warning-border)] rounded p-1">
        ...
        <div className="flex gap-1">
          ...
          <Button
            ...
            className="text-xs px-2 py-0.5 h-6 bg-success hover:brightness-95 flex-1"
          >
