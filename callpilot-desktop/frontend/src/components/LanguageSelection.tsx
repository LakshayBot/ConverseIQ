    ...
    <div className="space-y-4">
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-2">
          <Globe className="h-4 w-4 text-[var(--opaline-on-surface-variant)]" />
          <h4 className="text-sm font-medium text-[var(--opaline-on-surface)]">Transcription Language</h4>
        </div>
      </div>
      ...
      <div className="space-y-2">
        <select
          ...
          className="w-full px-3 py-2 text-sm bg-[var(--opaline-surface-container-lowest)] border border-[var(--opaline-outline-variant)] rounded-md shadow-sm focus:outline-none focus:ring-1 focus:ring-ring focus:border-primary disabled:bg-[var(--opaline-surface-container-low)] disabled:text-[var(--opaline-outline)]"
        >
        ...
        {isParakeet && (
          <div className="p-2 bg-[var(--opaline-warning-soft)] border border-[var(--opaline-warning-border)] rounded text-warning">
        ...
        <div className="text-xs space-y-2 pt-2">
          <p className="text-[var(--opaline-on-surface-variant)]">
          ...
          {selectedLanguage === 'auto' && (
            <div className="p-2 bg-[var(--opaline-warning-soft)] border border-[var(--opaline-warning-border)] rounded text-warning">
              <p className="font-medium flex items-center gap-1.5">
                ...
                Auto Detect may produce incorrect results
              </p>
              <p className="mt-1">For best accuracy, select your specific language (e.g., English, Spanish, etc.)</p>
            </div>
          )}
          {selectedLanguage === 'auto-translate' && (
            <div className="p-2 bg-[var(--opaline-info-soft)] border border-[var(--opaline-info-border)] rounded text-[var(--opaline-info)]">
              <p className="font-medium flex items-center gap-1.5">
