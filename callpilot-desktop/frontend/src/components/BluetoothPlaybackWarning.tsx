...
export function BluetoothPlaybackWarning({
  ...
  return (
    <Alert
      className="mb-4 border-[var(--opaline-warning-border)] bg-[var(--opaline-warning-soft)] text-warning"
      role="alert"
      aria-live="polite"
    >
      ...
      <div className="flex items-start justify-between w-full">
        <div className="flex-1">
          ...
          <AlertDescription className="text-warning mt-1">
            ...
            <br />
            <a
              href="https://github.com/your-org/callpilot/blob/main/BLUETOOTH_PLAYBACK_NOTICE.md"
              target="_blank"
        ...
        <Button
          ...
          className="ml-4 h-6 w-6 text-warning hover:text-warning hover:bg-[var(--opaline-warning-soft)]"
