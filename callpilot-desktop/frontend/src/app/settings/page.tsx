      ...
      <div className="flex-1 overflow-y-auto">
        <div className="max-w-6xl mx-auto p-8 pt-6">
          ...
          <Tabs value={activeTab} onValueChange={setActiveTab}>
            <TabsList className="bg-transparent relative rounded-none border-b border-[var(--opaline-outline-variant)] p-0 h-auto">
              {TABS.map((tab, index) => {
                const Icon = tab.icon;
                return (
                  <TabsTrigger
                    ...
                    className="flex items-center gap-2 px-6 py-4 bg-transparent rounded-none border-0 data-[state=active]:bg-transparent data-[state=active]:text-[var(--opaline-primary)] data-[state=active]:shadow-none text-[var(--opaline-on-surface-variant)] hover:text-[var(--opaline-on-surface)] relative z-10"
                  >
              ...
              <motion.div
                className="absolute bottom-0 z-20 h-0.5 bg-[var(--opaline-primary)]"
                layoutId="underline"
            ...
            <TabsContent value="callpilot" className="mt-6">
              <CallPilotServerSettings />
            </TabsContent>
