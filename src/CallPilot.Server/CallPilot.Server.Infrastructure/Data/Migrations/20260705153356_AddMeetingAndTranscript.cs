...
{
    /// <inheritdoc />
    public partial class AddMeetingAndTranscript : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StartOffset = table.Column<double>(type: "double precision", nullable: false),
                    EndOffset = table.Column<double>(type: "double precision", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TranscriptSegments_MeetingId_Sequence",
                table: "TranscriptSegments",
                columns: new[] { "MeetingId", "Sequence" });
        }
